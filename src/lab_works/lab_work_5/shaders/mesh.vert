...
#ifdef WAVES
    if(uIsLiquid) {
        modelspace.z = modelspace.z + sin(radians(modelspace.x) + 4000*uTimer)*(280-modelspace.y)/30;
        modelspace.z = modelspace.z + sin(radians(modelspace.y) + 4000*uTimer)*(280-modelspace.y)/30;
    }
#endif
