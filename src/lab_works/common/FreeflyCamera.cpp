...
namespace M3D_ISICG
{
	...
	Vec3f FreeflyCamera::getPosition() { return _position; }
	...
	void FreeflyCamera::_computeViewMatrix() { _viewMatrix = glm::lookAt( _position, _position - _invDirection, _up ); }
	...
	void FreeflyCamera::_computeUMVMatrix( const Mat4f & modelMatrix ) { _uMVMatrix = _viewMatrix * modelMatrix; }
